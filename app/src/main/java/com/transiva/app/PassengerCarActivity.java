...
public class PassengerCarActivity extends Activity {
    ...
    private String mapHtml() {
        ...
        return "<!DOCTYPE html><html><head>" +
                ...
                "function notifyCenter(){if(!map)return;var c=map.getCenter();if(centerMarker)centerMarker.setLngLat([c.lng,c.lat]);try{AndroidCar.onCenterChanged(c.lat,c.lng,c.lat,c.lng);}catch(e){}}" +
                ...
                "map.on('load',function(){styleNight();ensureRoute();setCenterMarker('pickup');var c=map.getCenter();try{AndroidCar.onMapReady(c.lat,c.lng,c.lat,c.lng);}catch(e){}});" +
